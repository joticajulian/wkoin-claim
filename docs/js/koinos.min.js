  ...
  var __webpack_modules__ = {
        ...
        e.exports = function (e) {
          ...
          function u(e) {
            ...
            if (" " !== e[r]) {
              ...
              for (
                var i = ((e.length - r) * c + 1) >>> 0, l = new Uint8Array(i);
                e[r];
          ...
          return {
            encode: function (t) {
              ...
              for (
                ...
                o++, r++;
              for (
                var c = ((i - o) * l + 1) >>> 0, u = new Uint8Array(c);
                o !== i;
              ...
              for (var h = c - n; h !== c && 0 === u[h]; ) h++;
              for (var y = a.repeat(r); h < c; ++h) y += e.charAt(u[h]);
              return y;
            },
            decodeUnsafe: u,
            decode: function (e) {
      ...
      830: (e, t, r) => {
        ...
        let c = [s],
          l = [a];
        for (let e = 0; e < 4; e++)
          for (let t of [c, l]) t.push(t[e].map((e) => i[e]));
        const u = [
        ...
        class b extends n.SHA2 {
          ...
          process(e, t) {
            ...
            for (let e = 0; e < 5; e++) {
              ...
              for (let e = 0; e < 16; e++) {
                const r = (y(n + _(t, i, a, b) + g[x[e]] + k, A[e]) + v) | 0;
      ...
      3061: (e, t, r) => {
        ...
        class l extends n.SHA2 {
          ...
          process(e, t) {
            ...
            let { A: r, B: n, C: a, D: l, E: u, F: p, G: d, H: f } = this;
            for (let e = 0; e < 64; e++) {
              const t =
                  (f +
                    ((0, o.rotr)(u, 6) ^
        ...
        t.sha256 = (0, o.wrapConstructor)(() => new l());
      },
      8089: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      9656: (e, t, r) => {
        ...
        const n = r(9159),
          ...
          u = {
            a: o,
            b: BigInt(7),
            P: l - s ** BigInt(32) - BigInt(977),
            n: l - BigInt("432420386565659656852420866394968145599"),
            h: i,
            Gx: BigInt(
        ...
        class f {
          ...
          static normalizeZ(e) {
            return f.toAffineBatch(e).map(f.fromAffine);
          }
          equals(e) {
            if (!(e instanceof f))
          ...
          negate() {
            return new f(this.x, T(-this.y), this.z);
          }
          double() {
          ...
          add(e) {
            ...
            const l = T(n ** s),
              ...
              _ = T(d - p),
              g = T(y - h);
            if (_ === o) return g === o ? this.double() : f.ZERO;
            const b = T(_ ** s),
              m = T(_ * b),
              v = T(p * b),
              w = T(g ** s - m - s * v),
          ...
          multiplyUnsafe(e) {
            ...
            let { k1neg: n, k1: s, k2neg: a, k2: c } = U(r),
              l = t,
              p = t,
              h = this;
            for (; s > o || c > o; )
          ...
          wNAF(e, t) {
            ...
            n ||
              ...
              t && 1 !== r && ((n = f.normalizeZ(n)), h.set(t, n)));
            let o = f.ZERO,
              s = f.ZERO;
            const a = 1 + (d ? 128 / r : 256 / r),
              c = 2 ** (r - 1),
              l = BigInt(2 ** r - 1),
              u = 2 ** r,
              p = BigInt(r);
            for (let t = 0; t < a; t++) {
              const r = t * c;
              let a = Number(e & l);
              if (((e >>= p), a > c && ((a -= u), (e += i)), 0 === a)) {
                let e = n[r];
                t % 2 && (e = e.negate()), (s = s.add(e));
              } else {
          ...
          multiply(e, t) {
            let r,
              ...
              o = P(e);
            if (d) {
              const { k1neg: e, k1: i, k2neg: s, k2: a } = U(o);
              let { p: c, f: l } = this.wNAF(i, t),
                { p, f: d } = this.wNAF(a, t);
              e && (c = c.negate()),
                s && (p = p.negate()),
                (p = new f(T(p.x * u.beta), p.y, p.z)),
              ...
              const { p: e, f: i } = this.wNAF(o, t);
              (r = e), (n = i);
            }
            return f.normalizeZ([r, n])[0];
          }
          toAffine(e = I(this.z)) {
            const { x: t, y: r, z: n } = this,
              o = e,
              ...
              c = T(t * s),
              l = T(r * a);
            if (T(n * o) !== i) throw new Error("invZ was invalid");
            return new y(c, l);
          }
        }
        (f.BASE = new f(u.Gx, u.Gy, i)), (f.ZERO = new f(o, i, o));
        const h = new WeakMap();
        class y {
          constructor(e, t) {
            (this.x = e), (this.y = t);
          ...
          _setWindowSize(e) {
            (this._WINDOW_SIZE = e), h.delete(this);
          }
          static fromCompressedHex(e) {
            const t = 32 === e.length,
              r = E(t ? e : e.subarray(1));
            if (!J(r)) throw new Error("Point is not on curve");
            let n = (function (e) {
              const { P: t } = u,
                r = BigInt(6),
                n = BigInt(11),
            ...
            const o = (n & i) === i;
            t ? o && (n = T(-n)) : (1 == (1 & e[0])) !== o && (n = T(-n));
            const c = new y(r, n);
            return c.assertValidity(), c;
          }
          static fromUncompressedHex(e) {
            const t = E(e.subarray(1, 33)),
              r = E(e.subarray(33, 65)),
              n = new y(t, r);
          ...
          static fromSignature(e, t, r) {
            ...
            const s = 1 & r ? "03" : "02",
              ...
              p = T(-n * l, c),
              d = T(i * l, c),
              f = y.BASE.multiplyAndAddUnsafe(a, p, d);
            if (!f)
          ...
          toHex(e = !1) {
            const t = O(this.x);
            return e ? `${this.y & i ? "03" : "02"}${t}` : `04${t}${O(this.y)}`;
          }
          toHexX() {
          ...
          assertValidity() {
            const e = "Point is not on elliptic curve",
              { x: t, y: r } = this;
            if (!J(t) || !J(r)) throw new Error(e);
            const n = T(r * r);
            if (T(n - p(t)) !== o) throw new Error(e);
          }
          equals(e) {
            return this.x === e.x && this.y === e.y;
          }
          negate() {
            return new y(this.x, T(-this.y));
          }
          double() {
            return f.fromAffine(this).double().toAffine();
          }
          add(e) {
            return f.fromAffine(this).add(f.fromAffine(e)).toAffine();
          }
          subtract(e) {
            return this.add(e.negate());
          }
          multiply(e) {
            return f.fromAffine(this).multiply(e, this).toAffine();
          }
          multiplyAndAddUnsafe(e, t, r) {
            const n = f.fromAffine(this),
              s =
                t === o || t === i || this !== y.BASE
                  ? n.multiplyUnsafe(t)
                  : n.multiply(t),
              ...
              c = s.add(a);
            return c.equals(f.ZERO) ? void 0 : c.toAffine();
          }
        }
        function _(e) {
        ...
        (t.Point = y), (y.BASE = new y(u.Gx, u.Gy)), (y.ZERO = new y(o, o));
        class b {
          constructor(e, t) {
          ...
          static fromCompact(e) {
            ...
            return new b(A(n.slice(0, 64)), A(n.slice(64, 128)));
          }
          static fromDER(e) {
            const t = v(e);
            if ("string" != typeof e && !t)
            ...
            const { r, s: n } = (function (e) {
              ...
              const { data: t, left: r } = g(e.subarray(2)),
                { data: n, left: o } = g(r);
              if (o.length)
                throw new Error(
          ...
          normalizeS() {
            return this.hasHighS() ? new b(this.r, u.n - this.s) : this;
          }
          toDERRawBytes(e = !1) {
            return j(this.toDERHex(e));
          }
          toDERHex(e = !1) {
            const t = _(S(this.s));
            if (e) return t;
        ...
        function m(...e) {
          if (!e.every(v)) throw new Error("Uint8Array list expected");
          if (1 === e.length) return e[0];
          const t = e.reduce((e, t) => e + t.length, 0),
            r = new Uint8Array(t);
          for (let t = 0, n = 0; t < e.length; t++) {
        ...
        function O(e) {
          if (e > l) throw new Error("Expected number < 2^256");
        ...
        function P(e) {
          if ("number" == typeof e && Number.isSafeInteger(e) && e > 0)
            return BigInt(e);
          if ("bigint" == typeof e && C(e)) return e;
          throw new TypeError(
        ...
        function U(e) {
          ...
          const d = l > D,
            f = p > D;
          if ((d && (l = t - l), f && (p = t - p), l > D || p > D))
            throw new Error("splitScalarEndo: Endomorphism failed, k=" + e);
          return { k1neg: d, k1: l, k2neg: f, k2: p };
        }
        function R(e) {
          const { n: t } = u,
            r = 8 * e.length - 256;
        ...
        function $(e, t, r) {
          ...
          const { n: s } = u,
            ...
            c = T(a.x, s);
          if (c === o) return;
          const l = T(I(n, s) * T(t + r * c, s), s);
          if (l === o) return;
          const p = new b(c, l);
          return { sig: p, recovery: (a.x === p.r ? 0 : 2) | Number(a.y & i) };
        }
        function H(e) {
          let t;
          ...
          if (!C(t)) throw new Error("Expected private key: 0 < key < n");
          return t;
        }
        function M(e) {
        ...
        (t.getPublicKey = function (e, t = !1) {
          ...
          (t.recoverPublicKey = function (e, t, r, n = !1) {
            return y.fromSignature(e, t, r).toRawBytes(n);
          }),
          (t.getSharedSecret = function (e, t, r = !1) {
            ...
            const n = M(t);
            return n.assertValidity(), n.multiply(H(e)).toRawBytes(r);
          }),
          (t.sign = async function (e, t, r = {}) {
            const { seed: n, m: o, d: i } = W(e, t, r.extraEntropy);
            let s;
            const a = new z();
            for (await a.reseed(n); !(s = $(await a.generate(), o, i)); )
              await a.reseed();
            return Z(s, r);
          }),
          (t.signSync = function (e, t, r = {}) {
            ...
            let s;
            const a = new z();
            for (a.reseedSync(n); !(s = $(a.generateSync(), o, i)); )
              a.reseedSync();
            return Z(s, r);
          });
        const X = { strict: !0 };
        ...
        t.verify = function (e, t, r, n = X) {
          ...
          const { n: l } = u,
            ...
            d = T(a * p, l),
            f = T(i * p, l),
            h = y.BASE.multiplyAndAddUnsafe(c, d, f);
          return !!h && T(h.x, l) === i;
        };
        class ee {
          constructor(e, t) {
          ...
          static fromHex(e) {
            ...
            const r = E(t.subarray(0, 32)),
              n = E(t.subarray(32, 64));
            return new ee(r, n);
          }
          assertValidity() {
            const { r: e, s: t } = this;
            if (!J(e) || !C(t)) throw new Error("Invalid signature");
          }
          toHex() {
            return O(this.r) + O(this.s);
          }
        ...
        function ne(e) {
          ...
          const r = y.fromPrivateKey(t),
            n = r.toRawX();
          return { R: r, rx: n, k: Y(r) ? t : u.n - t };
        }
        function oe(e, t, r, n) {
          return new ee(e.x, T(t + r * n, u.n)).toRawBytes();
        }
        function ie(e, t, r) {
          const n = e instanceof ee,
            o = n ? e : ee.fromHex(e);
          return n && o.assertValidity(), { ...o, m: B(t), P: M(r) };
        }
        function se(e, t, r, n) {
          const o = y.BASE.multiplyAndAddUnsafe(t, H(r), T(-n, u.n));
          return !(!o || !Y(o) || o.x !== e);
        }
        async function ae(e, r, n) {
          try {
            const { r: o, s: i, m: s, P: a } = ie(e, r, n),
              c = Q(
                await t.utils.taggedHash(ue.challenge, x(o), a.toRawX(), s)
              );
            return se(o, a, i, c);
          } catch (e) {
            return !1;
        ...
        function ce(e, r, n) {
          try {
            const { r: o, s: i, m: s, P: a } = ie(e, r, n),
              c = Q(t.utils.taggedHashSync(ue.challenge, x(o), a.toRawX(), s));
            return se(o, a, i, c);
          } catch (e) {
            return !1;
          }
        ...
        (t.schnorr = {
          ...
          sign: async function (e, r, n = t.utils.randomBytes()) {
            const { m: o, px: i, d: s, rand: a } = te(e, r, n),
              c = re(s, await t.utils.taggedHash(ue.aux, a)),
              {
                R: l,
                rx: u,
                k: p,
              } = ne(await t.utils.taggedHash(ue.nonce, c, i, o)),
              d = oe(
                l,
                p,
                Q(await t.utils.taggedHash(ue.challenge, u, i, o)),
                s
              );
            if (!(await ae(d, o, i)))
          ...
          verify: ae,
          signSync: function (e, r, n = t.utils.randomBytes()) {
            const { m: o, px: i, d: s, rand: a } = te(e, r, n),
              c = re(s, t.utils.taggedHashSync(ue.aux, a)),
              {
                R: l,
                rx: u,
                k: p,
              } = ne(t.utils.taggedHashSync(ue.nonce, c, i, o)),
              d = oe(l, p, Q(t.utils.taggedHashSync(ue.challenge, u, i, o)), s);
            if (!ce(d, o, i))
              throw new Error("sign: Invalid signature produced");
            return d;
          },
        ...
        t.utils = {
          ...
          privateAdd: (e, t) => x(T(H(e) + H(t), u.n)),
          privateNegate: (e) => {
            const t = H(e);
            return x(u.n - t);
          },
          pointAddScalar: (e, t, r) => {
            const n = y.fromHex(e),
              o = H(t),
              s = y.BASE.multiplyAndAddUnsafe(n, o, i);
          ...
          sha256: async (...e) => {
            if (le.web) {
              const t = await le.web.subtle.digest("SHA-256", m(...e));
              return new Uint8Array(t);
            }
            if (le.node) {
              const { createHash: t } = le.node,
                r = t("sha256");
          ...
          hmacSha256: async (e, ...t) => {
            if (le.web) {
              const r = await le.web.subtle.importKey(
                  "raw",
                  e,
                ...
                n = m(...t),
                o = await le.web.subtle.sign("HMAC", r, n);
              return new Uint8Array(o);
            }
            if (le.node) {
              const { createHmac: r } = le.node,
                n = r("sha256", e);
      ...
      7419: (e, t) => {
        ...
        r.encode = function (e, t, r) {
          for (var o, i = null, s = [], a = 0, c = 0; t < r; ) {
            ...
            switch (c) {
              case 0:
                (s[a++] = n[l >> 2]), (o = (3 & l) << 4), (c = 1);
                break;
              case 1:
                (s[a++] = n[o | (l >> 4)]), (o = (15 & l) << 2), (c = 2);
                break;
              case 2:
                (s[a++] = n[o | (l >> 6)]), (s[a++] = n[63 & l]), (c = 0);
            }
            a > 8191 &&
        ...
        (r.decode = function (e, t, r) {
          for (var n, i = r, a = 0, c = 0; c < e.length; ) {
            ...
            if ("string" != typeof e) {
              ...
              if (
                ...
                for (
                  ...
                  (a[l] = s[l]), (c[l] = e[s[l++]]);
                return (a[l] = r), Function.apply(null, a).apply(null, c);
              }
              return Function(r)();
            }
            for (var u = new Array(arguments.length - 1), p = 0; p < u.length; )
              u[p] = arguments[++p];
            if (
              ((p = 0),
              ...
              : (function () {
                  ...
                  function s(e, t, r, n, o) {
                    ...
                    return 2047 === c
                      ...
                      : 0 === c
                      ? 5e-324 * a * l
                      : a * Math.pow(2, c - 1075) * (l + 4503599627370496);
                  }
      ...
      5077: (e, t, r) => {
        ...
        const n = r(8820),
          ...
          u = c.reduce((e, t) => ((e[t[1]] = l[t[0]]), e), {});
        e.exports = { names: l, codes: u };
      },
      6957: (e, t, r) => {
        "use strict";
        const n = r(5077),
        ...
        (n.fromObject = function (e) {
          ...
          for (var n = 0; n < t.length; ++n) {
            ...
            a.map
              ...
              ? (r("if(d%s){", c)("if(!Array.isArray(d%s))", c)(
                ...
                s(r, a, n, c + "[i]")("}")("}"))
              : (a.resolvedType instanceof o || r("if(d%s!=null){", c),
                s(r, a, n, c),
          ...
          (n.toObject = function (e) {
            ...
            for (
              ...
              t[l].partOf ||
                (t[l].resolve().repeated ? n : t[l].map ? s : c).push(t[l]);
            if (n.length) {
              for (r("if(o.arrays||o.defaults){"), l = 0; l < n.length; ++l)
                r("d%s=[]", i.safeProp(n[l].name));
              r("}");
            }
            if (s.length) {
              for (r("if(o.objects||o.defaults){"), l = 0; l < s.length; ++l)
                r("d%s={}", i.safeProp(s[l].name));
              r("}");
            }
            if (c.length) {
              for (r("if(o.defaults){"), l = 0; l < c.length; ++l) {
                var u = c[l],
                  p = i.safeProp(u.name);
              ...
              (p = i.safeProp(u.name)),
                u.map
                  ...
                  ? (r("if(m%s&&m%s.length){", p, p)("d%s=[]", p)(
                    ...
                    a(r, u, h, p + "[j]")("}"))
                  : (r("if(m%s!=null&&m.hasOwnProperty(%j)){", p, u.name),
                    a(r, u, h, p),
                    u.partOf &&
                      r("if(o.oneofs)")(
                        "d%s=%j",
        ...
        e.exports = function (e) {
          for (
            ...
            var l = a[c].resolve(),
              ...
              p = l.resolvedType instanceof n ? "int32" : l.type,
              d = o.basic[p];
              ...
              l.map
                ? (r(
                  ...
                  void 0 === d
                    ...
                    : r(".uint32(%i).%s(%s[ks[i]]).ldelim()", 16 | d, p, t),
                  r("}")("}"))
                : l.repeated
                ? (r("if(%s!=null&&%s.length){", t, t),
                  l.packed && void 0 !== o.packed[p]
                    ? r("w.uint32(%i).fork()", ((l.id << 3) | 2) >>> 0)(
                ...
                : (l.optional &&
                  ...
                  void 0 === d
                    ? s(r, l, u, t)
                    : r("w.uint32(%i).%s(%s)", ((l.id << 3) | d) >>> 0, p, t));
          }
          return r("return w");
        };
        var n = r(7025),
      ...
      3548: (e, t, r) => {
        ...
        function l(e, t, r, o, i, l, u) {
          if (
            (a.isObject(o)
              ? ((u = i), (l = o), (o = i = void 0))
              : a.isObject(i) && ((u = l), (l = i), (i = void 0)),
            n.call(this, e, l),
            !a.isInteger(t) || t < 0)
          )
      ...
      4429: (e, t, r) => {
        ...
        ((i.prototype = Object.create(n.prototype)).constructor = i).className =
          "Method";
        var o = r(9935);
        function i(e, t, r, i, s, a, c, l, u) {
          if (
            (o.isObject(s)
              ? ((c = s), (s = a = void 0))
              : o.isObject(a) && ((c = a), (a = void 0)),
        ...
        (u.fromJSON = function (e, t) {
          ...
          (u.prototype.lookup = function (e, t, r) {
            ...
            if (n) {
              ...
              } else if (n instanceof u && (n = n.lookup(e.slice(1), t, !0)))
                return n;
            } else
              for (var o = 0; o < this.nestedArray.length; ++o)
                if (
                  this._nestedArray[o] instanceof u &&
      ...
      9424: (e, t, r) => {
        ...
        (p.fromJSON = function (e, t) {
          ...
          (p.prototype.resolvePath = u.path.resolve),
          (p.prototype.fetch = u.fetch),
                ...
                if (
                  ...
                  if (s.imports)
                    for (; p < s.imports.length; ++p)
                      (n = l(s.imports[p]) || o.resolvePath(e, s.imports[p])) &&
                        f(n);
                  if (s.weakImports)
                    for (p = 0; p < s.weakImports.length; ++p)
                      (n =
                        l(s.weakImports[p]) ||
                        o.resolvePath(e, s.weakImports[p])) && f(n, !0);
        ...
        Object.defineProperties(b.prototype, {
          ...
          (b.fromJSON = function (e, t) {
            ...
            for (var l = Object.keys(t.fields), u = 0; u < l.length; ++u)
              r.add(
                (void 0 !== t.fields[l[u]].keyType ? a.fromJSON : s.fromJSON)(
                  l[u],
                  t.fields[l[u]]
                )
              );
            if (t.oneofs)
              for (l = Object.keys(t.oneofs), u = 0; u < l.length; ++u)
                r.add(i.fromJSON(l[u], t.oneofs[l[u]]));
            if (t.nested)
          ...
          (b.prototype.setup = function () {
            ...
            (this.encode = f(this)({ Writer: p, types: t, util: d })),
              (this.decode = h(this)({ Reader: u, types: t, util: d })),
              (this.verify = y(this)({ types: t, util: d })),
              (this.fromObject = _.fromObject(this)({ types: t, util: d })),
              (this.toObject = _.toObject(this)({ types: t, util: d }));
            var n = g[e];
            if (n) {
      ...
      4497: (e, t, r) => {
        ...
        e.exports = function (e) {
          ...
          for (var n = 0; n < e.fieldsArray.length; ++n) {
            ...
            if (
              (c.optional &&
                t("if(%s!=null&&m.hasOwnProperty(%j)){", l, c.name),
              c.map)
            )
      ...
      1173: (e, t, r) => {
        ...
        (p.create = d()),
          ...
          o.Array !== Array &&
            (p.alloc = o.pool(p.alloc, o.Array.prototype.subarray)),
        ...
        class i {
          constructor(e) {
            ...
            e.id && (this.id = (0, o.decodeBase58)(e.id)),
              ...
              e.serializer
                ...
                : e.abi &&
                  e.abi.koilib_types &&
                  (this.serializer = new n.Serializer(e.abi.koilib_types)),
              (this.options = {
                signTransaction: !0,
                sendTransaction: !0,
                broadcast: !0,
              ...
              this.abi &&
                ...
                Object.keys(this.abi.methods).forEach((e) => {
                  this.functions[e] = async (t = {}, r) => {
                    ...
                    const n = { ...this.options, ...r },
                      {
                        ...
                        return: s,
                        default_output: a,
                        preformat_argument: c,
                        preformat_return: l,
                      } = this.abi.methods[e];
                    let u;
                    u = "function" == typeof c ? c(t) : t;
                    const p = await this.encodeOperation({ name: e, args: u });
                    if (n.onlyOperation) return { operation: p };
                    if (i) {
                      ...
                      return (
                        ...
                        "function" == typeof l && (r = l(r)),
                        { operation: p, result: r }
                      );
                    }
                    if (!this.signer) throw new Error("signer not found");
                    let d = await this.signer.prepareTransaction({
                      header: {
                        ...(n.chainId && { chain_id: n.chainId }),
                        ...(n.rcLimit && { rc_limit: n.rcLimit }),
                        ...(n.nonce && { nonce: n.nonce }),
                        ...(n.payer && { payer: n.payer }),
                        ...(n.payee && { payee: n.payee }),
                      },
                      operations: [
                        ...(n.previousOperations ? n.previousOperations : []),
                        p,
                        ...(n.nextOperations ? n.nextOperations : []),
                      ],
                    });
                    const f = {
                    ...
                    if (n.sendAbis) {
                      f.abis = {};
                      const e = (0, o.encodeBase58)(this.id);
                      f.abis[e] = this.abi;
                    }
                    if (!n.sendTransaction) {
                      const e = () => {
                        throw new Error("This transaction was not broadcasted");
                      };
                      return (
                        n.signTransaction &&
                          (d = await this.signer.signTransaction(d, f.abis)),
                        { operation: p, transaction: { ...d, wait: e } }
                      );
                    }
                    const { transaction: h, receipt: y } =
                      await this.signer.sendTransaction(d, f);
                    return { operation: p, transaction: h, receipt: y };
                  };
                });
          }
          getId() {
          ...
          async deploy(e) {
            ...
            const t = { ...this.options, ...e },
              r = {
                upload_contract: {
                  contract_id: this.id
                    ? (0, o.encodeBase58)(this.id)
                    : this.signer.getAddress(),
                  bytecode: (0, o.encodeBase64url)(this.bytecode),
                  ...(t.abi && { abi: t.abi }),
                  ...(t.authorizesCallContract && {
                    authorizes_call_contract: t.authorizesCallContract,
                  }),
                  ...(t.authorizesTransactionApplication && {
                    authorizes_transaction_application:
                      t.authorizesTransactionApplication,
                  }),
                  ...(t.authorizesUploadContract && {
                    authorizes_upload_contract: t.authorizesUploadContract,
                  }),
                },
              };
            if (t.onlyOperation) return { operation: r };
            let n = await this.signer.prepareTransaction({
              header: {
                ...(t.chainId && { chain_id: t.chainId }),
                ...(t.rcLimit && { rc_limit: t.rcLimit }),
                ...(t.nonce && { nonce: t.nonce }),
                ...(t.payer && { payer: t.payer }),
                ...(t.payee && { payee: t.payee }),
              },
              operations: [
                ...(t.previousOperations ? t.previousOperations : []),
                r,
                ...(t.nextOperations ? t.nextOperations : []),
              ],
            });
            const i = { broadcast: t.broadcast, beforeSend: t.beforeSend };
            if (!t.sendTransaction) {
              const e = () => {
                throw new Error("This transaction was not broadcasted");
              };
              return (
                t.signTransaction && (n = await this.signer.signTransaction(n)),
                { operation: r, transaction: { ...n, wait: e } }
              );
            }
            const { transaction: s, receipt: a } =
              await this.signer.sendTransaction(n, i);
            return { operation: r, transaction: s, receipt: a };
          }
          async encodeOperation(e) {
            ...
            if (t.argument) {
              if (!e.args)
                throw new Error(
                  `No arguments defined for type '${t.argument}'`
                );
              r = await this.serializer.serialize(e.args, t.argument);
            }
            return {
              call_contract: {
          ...
          async decodeOperation(e) {
            ...
            for (let t = 0; t < Object.keys(this.abi.methods).length; t += 1) {
              ...
              if (e.call_contract.entry_point === n.entry_point)
                return n.argument
                  ? {
                      name: r,
      ...
      5635: (e, t, r) => {
        ...
        class s {
          ...
          async wait(e, t = "byBlock", r = 15e3) {
            ...
            if ("byTransactionId" === t) {
              for (; Date.now() < n + r; ) {
                ...
                if (t && t[0] && t[0].containing_blocks)
                  return { blockId: t[0].containing_blocks[0] };
              }
            ...
            const o = async (t, r, n) => {
              ...
              o.forEach((t) => {
                t &&
                  ...
                  ((i = Number(t.block_height)), (s = t.block_id));
              });
              const a = o[o.length - 1].block_id;
              return [i, s, a];
            };
            let s = 0,
              a = 0,
            ...
            for (; Date.now() < n + r; ) {
              ...
              if (
                ...
                const [t, r, n] = await o(a, Number(e.height) - a + 1, e.id);
                if (t) return { blockId: r, blockNumber: t };
                (c = n), (s = Number(e.height) + 1);
              }
              if (s > Number(e.height)) continue;
              const [t, r, n] = await o(s, 1, e.id);
              if (t) return { blockId: r, blockNumber: t };
              c || (c = n), (s += 1);
            }
            throw new Error(
          ...
          async sendTransaction(e, t = !0) {
            const r = await this.call("chain.submit_transaction", {
              transaction: e,
              broadcast: t,
            });
            return (
              (e.wait = async (t = "byBlock", r = 15e3) =>
                this.wait(e.id, t, r)),
              { ...r, transaction: e }
            );
          }
        ...
        class a {
          constructor(e, t) {
            (this.bytesConversion = !0),
              (this.verifyChecksum = { serialize: !0, deserialize: !1 }),
              (this.types = e),
          ...
          btypeDecode(e, t, r) {
            ...
            return (
              Object.keys(t.fields).forEach((a) => {
                const { options: c, name: l, type: u, rule: p } = t.fields[a];
                if (!e[l]) return;
                const d = { type: u };
                if (
                  (c &&
                  ...
                  if (!s.includes(u)) {
                    const t = this.root.lookupTypeOrEnum(u);
                    return t.fields
                      ? void (n[l] = this.btypeDecode(e[l], t, r))
                      : void (n[l] = e[l]);
                  }
                  n[l] = (0, o.btypeDecodeValue)(e[l], d, r);
                } else
                  n[l] = e[l].map((e) => {
                    if (!s.includes(u)) {
                      const t = this.root.lookupTypeOrEnum(u);
                      return t.fields ? this.btypeDecode(e, t, r) : e;
                    }
                    return (0, o.btypeDecodeValue)(e, d, r);
                  });
              }),
              n
            );
              ...
              Object.keys(t.fields).forEach((a) => {
                ...
                if (
                  ...
                  if (!s.includes(u)) {
                    const t = this.root.lookupTypeOrEnum(u);
                    return t.fields
                      ? void (n[l] = this.btypeEncode(e[l], t, r))
                      : void (n[l] = e[l]);
                  }
                  n[l] = (0, o.btypeEncodeValue)(e[l], d, r);
                } else
                  n[l] = e[l].map((e) => {
                    if (!s.includes(u)) {
                      const t = this.root.lookupTypeOrEnum(u);
                      return t.fields ? this.btypeEncode(e, t, r) : e;
                    }
                    return (0, o.btypeEncodeValue)(e, d, r);
                  });
              }),
              n
            );
          ...
          async serialize(e, t, r) {
            ...
            const i =
                void 0 === (null == r ? void 0 : r.bytesConversion)
                  ...
                  : r.bytesConversion,
              s =
                void 0 === (null == r ? void 0 : r.verifyChecksum)
                  ? this.verifyChecksum.serialize
                  : r.verifyChecksum;
            o = i ? this.btypeDecode(e, n, s) : e;
            const a = n.create(o);
            ...
            const n = "string" == typeof e ? (0, o.decodeBase64url)(e) : e,
              ...
              l =
                void 0 === (null == r ? void 0 : r.verifyChecksum)
                  ...
                  : r.verifyChecksum;
            return c ? this.btypeEncode(a, i, l) : a;
          }
        }
        ...
        class f {
          constructor(e) {
            (this.chainId = ""),
              ...
              (this.address = (0, c.bitcoinAddress)(this.publicKey)),
              e.chainId && (this.chainId = e.chainId),
              (this.sendOptions = { broadcast: !0, ...e.sendOptions });
          }
          static fromWif(e, t = !0) {
            const r = void 0 === t ? "5" !== e[0] : t,
              n = (0, c.bitcoinDecode)(e);
            return new f({ privateKey: (0, c.toHexString)(n), compressed: r });
          }
          ...
          getAddress(e = !0) {
            if ("string" == typeof this.privateKey) {
              ...
              return (0, c.bitcoinAddress)(t);
            }
            const t = a.getPublicKey(this.privateKey, e);
            return (0, c.bitcoinAddress)(t);
          }
          getPrivateKey(e = "hex", t = !1) {
            let r;
            r =
              this.privateKey instanceof Uint8Array
                ? (0, c.toHexString)(this.privateKey)
          ...
          async signMessage(e) {
            return this.signHash((0, s.sha256)(e));
          }
          async signTransaction(e, t) {
            if (!e.id) throw new Error("Missing transaction id");
            const r = (0, c.toUint8Array)(e.id.slice(6)),
              n = await this.signHash(r);
            return (
              e.signatures || (e.signatures = []),
              e.signatures.push((0, c.encodeBase64url)(n)),
              e
            );
          }
          async signBlock(e) {
            if (!e.id) throw new Error("Missing block id");
            const t = (0, c.toUint8Array)(e.id.slice(6)),
              r = await this.signHash(t);
            return (e.signature = (0, c.encodeBase64url)(r)), e;
          }
          async sendTransaction(e, t) {
            ...
            const n = { ...this.sendOptions, ...t };
            return (
              n.beforeSend && (await n.beforeSend(e)),
              this.provider.sendTransaction(e, n.broadcast)
            );
          }
          static recoverPublicKey(e, t, r = !0) {
            const n = (0, c.toHexString)(t),
              o = Number(`0x${n.slice(0, 2)}`) - 31,
              i = n.slice(2, 66),
              s = n.slice(66),
              l = BigInt(`0x${i}`),
              u = BigInt(`0x${s}`),
              p = new a.Signature(l, u),
              d = a.recoverPublicKey((0, c.toHexString)(e), p.toHex(), o);
            if (!d) throw new Error("Public key cannot be recovered");
            return r ? a.Point.fromHex(d).toHex(!0) : (0, c.toHexString)(d);
          }
          static recoverAddress(e, t, r = !0) {
            return (0, c.bitcoinAddress)(
              (0, c.toUint8Array)(f.recoverPublicKey(e, t, r))
            );
          }
          async recoverPublicKeys(e, t) {
            ...
            if (i.signature) {
              ...
              o = [i.signature];
              const e = (0, c.btypeDecode)(i.header, u, !1),
                t = l.koinos.protocol.block_header.create(e);
              n = l.koinos.protocol.block_header.encode(t).finish();
            } else {
              const t = e;
              ...
              o = t.signatures;
              const r = (0, c.btypeDecode)(t.header, p, !1),
                i = l.koinos.protocol.transaction_header.create(r);
              n = l.koinos.protocol.transaction_header.encode(i).finish();
            }
            ...
            return Promise.all(
              o.map(
                async (e) => (
                  ...
                  f.recoverPublicKey(a, (0, c.decodeBase64url)(e), r)
                )
              )
            );
          }
          async recoverAddresses(e, t) {
            return (await this.recoverPublicKeys(e, t)).map((e) =>
              (0, c.bitcoinAddress)((0, c.toUint8Array)(e))
            );
          }
          async prepareTransaction(e) {
            ...
            if (void 0 === e.header.nonce) {
              ...
              const e = await this.provider.getNonce(o || n),
                t = l.koinos.chain.value_type.create({
                  uint64_value: String(e + 1),
                }),
                r = l.koinos.chain.value_type.encode(t).finish();
              i = (0, c.encodeBase64url)(r);
            ...
            if (e.operations)
              for (
                ...
                const r = (0, c.btypeDecode)(e.operations[t], d, !1),
                  n = l.koinos.protocol.operation.create(r),
                  o = l.koinos.protocol.operation.encode(n).finish();
                f.push((0, s.sha256)(o));
              }
            const h = (0, c.encodeBase64url)(
              new Uint8Array([18, 32, ...(0, c.calculateMerkleRoot)(f)])
            );
            e.header = {
              chain_id: u,
              rc_limit: a,
            ...
            const y = (0, c.btypeDecode)(e.header, p, !1),
              _ = l.koinos.protocol.transaction_header.create(y),
              g = l.koinos.protocol.transaction_header.encode(_).finish(),
              b = (0, s.sha256)(g);
            return (e.id = `0x1220${(0, c.toHexString)(b)}`), e;
          }
          async prepareBlock(e) {
            ...
            if (e.transactions)
              for (let n = 0; n < e.transactions.length; n++) {
                const o = e.transactions[n],
                  i = (0, c.btypeDecode)(o.header, p, !1),
                  a = l.koinos.protocol.transaction_header.create(i),
                  u = l.koinos.protocol.transaction_header.encode(a).finish();
                r.push((0, s.sha256)(u));
                let d = new Uint8Array();
                null === (t = o.signatures) ||
                  void 0 === t ||
                  t.forEach((e) => {
                    d = new Uint8Array([...d, ...(0, c.decodeBase64url)(e)]);
                  }),
                  r.push((0, s.sha256)(d));
              }
            let {
            ...
            e.header = {
              ...
              transaction_merkle_root: (0, c.encodeBase64url)(
                new Uint8Array([18, 32, ...(0, c.calculateMerkleRoot)(r)])
              ),
              signer: this.address,
            };
            const a = (0, c.btypeDecode)(e.header, u, !1),
              d = l.koinos.protocol.block_header.create(a),
              f = l.koinos.protocol.block_header.encode(d).finish(),
              h = (0, s.sha256)(f);
            return (e.id = `0x1220${(0, c.toHexString)(h)}`), e;
          }
        }
      ...
      8593: function (e, t, r) {
        ...
        function g(e, t, r = !1) {
          ...
          "public" === t
            ...
            : (r
              ...
              (o[0] = 128)),
            o.set(e, 1);
          const s = (0, c.sha256)(o),
            a = (0, c.sha256)(s),
            l = new Uint8Array(4);
          return l.set(a.slice(0, 4)), n.set(e, 1), n.set(l, i), f(n);
        }
        function b(e) {
          const t = e.length - 4,
            r = new Uint8Array(t);
          ...
          n.set(e.slice(t));
          const o = (0, c.sha256)((0, c.sha256)(r));
          for (let e = 0; e < 4; e += 1) if (n[e] !== o[e]) return !1;
          return !0;
        }
        function m(e) {
          const t = "string" == typeof e ? h(e) : e;
          return 25 === t.length && 0 === t[0] && b(t);
        }
        function v(e) {
        ...
        function w(e, t, r) {
          if ("bytes" !== t.type) return v(e);
          const n = e;
          if (!t.btype) return _(n);
          switch (t.btype) {
            case "BASE58":
              return h(n);
            case "CONTRACT_ID":
            case "ADDRESS":
              const e = h(n);
              if (r && !m(e)) throw new Error(`${n} is an invalid address`);
              return e;
            case "BASE64":
              return _(n);
            case "HEX":
        ...
        function k(e, t, r) {
          ...
          switch (t.btype) {
            ...
            case "ADDRESS":
              const e = f(n);
              if (r && !m(n)) throw new Error(`${e} is an invalid address`);
              return e;
            case "BASE64":
              return y(n);
            case "HEX":
        ...
        (t.toUint8Array = p),
          ...
          (t.calculateMerkleRoot = function (e) {
            if (!e.length) return (0, c.sha256)(new Uint8Array());
            for (; e.length > 1; ) {
              for (let t = 0; t < e.length; t += 2)
                if (t + 1 < e.length) {
                  const r = e[t],
                    n = e[t + 1],
                    o = (0, c.sha256)(new Uint8Array([...r, ...n]));
          ...
          (t.bitcoinAddress = function (e) {
            ...
            return g((0, l.ripemd160)(t), "public");
          }),
          (t.isChecksum = b),
          (t.isChecksumAddress = m),
          (t.isChecksumWif = function (e) {
            const t = "string" == typeof e ? h(e) : e;
            return (
              (37 === t.length || 38 === t.length) &&
              (!(38 === t.length) || 1 === t[33]) &&
              128 === t[0] &&
              b(t)
            );
          ...
          (t.btypeDecodeValue = w),
          (t.btypeEncodeValue = k),
          (t.btypeDecode = function e(t, r, n) {
            ...
            return (
              Object.keys(r).forEach((i) => {
                t[i] &&
                  ("repeated" === r[i].rule
                    ? (o[i] = t[i].map((t) =>
                        r[i].subtypes ? e(t, r[i].subtypes, n) : w(t, r[i], n)
                      ))
                    : r[i].subtypes
                    ? (o[i] = e(t[i], r[i].subtypes, n))
                    : (o[i] = w(t[i], r[i], n)));
              }),
              o
            );
          }),
          (t.btypeEncode = function e(t, r, n) {
            if ("object" != typeof t) return t;
            const o = {};
            return (
              Object.keys(r).forEach((i) => {
                t[i] &&
                  ("repeated" === r[i].rule
                    ? (o[i] = t[i].map((t) =>
                        r[i].subtypes ? e(t, r[i].subtypes, n) : k(t, r[i], n)
                      ))
                    : r[i].subtypes
                    ? (o[i] = e(t[i], r[i].subtypes, n))
                    : (o[i] = k(t[i], r[i], n)));
            ...
            (i =
              ...
              typeof (n = function (e) {
                ...
                var t,
                  ...
                  a = e.Writer,
                  c = e.util,
                  l = e.roots.default || (e.roots.default = {});
                return (
                  (l.koinos =
                    (((i = {}).protocol =
                      (((n = {}).event_data = (function () {
                        ...
                        return (
                          ...
                          (t.prototype.source = c.newBuffer([])),
                          (t.prototype.name = ""),
                          (t.prototype.data = c.newBuffer([])),
                          (t.prototype.impacted = c.emptyArray),
                          (t.create = function (e) {
                            return new t(e);
                          }),
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n = new l.koinos.protocol.event_data();
                              e.pos < r;
                          ...
                          (t.fromObject = function (e) {
                            if (e instanceof l.koinos.protocol.event_data)
                              return e;
                            var t = new l.koinos.protocol.event_data();
                            if (
                              (null != e.sequence &&
                              ...
                              null != e.source &&
                                ("string" == typeof e.source
                                  ? c.base64.decode(
                                      e.source,
                                      (t.source = c.newBuffer(
                                        c.base64.length(e.source)
                                      )),
                                      0
                                    )
                                  : e.source.length >= 0 &&
                              ...
                              null != e.data &&
                                ("string" == typeof e.data
                                  ? c.base64.decode(
                                      e.data,
                                      (t.data = c.newBuffer(
                                        c.base64.length(e.data)
                                      )),
                                      0
                                    )
                                  : e.data.length >= 0 && (t.data = e.data)),
                              e.impacted)
                            ) {
                              if (!Array.isArray(e.impacted))
                                throw TypeError(
                              ...
                              for (var r = 0; r < e.impacted.length; ++r)
                                "string" == typeof e.impacted[r]
                                  ? c.base64.decode(
                                      e.impacted[r],
                                      (t.impacted[r] = c.newBuffer(
                                        c.base64.length(e.impacted[r])
                                      )),
                                      0
                                    )
                                  : e.impacted[r].length >= 0 &&
                            ...
                            if (
                              ...
                              t.defaults &&
                                ...
                                t.bytes === String
                                  ...
                                  : ((r.source = []),
                                    t.bytes !== Array &&
                                      (r.source = c.newBuffer(r.source))),
                                (r.name = ""),
                                t.bytes === String
                                  ? (r.data = "")
                                  : ((r.data = []),
                                    t.bytes !== Array &&
                                      (r.data = c.newBuffer(r.data)))),
                              null != e.sequence &&
                                e.hasOwnProperty("sequence") &&
                              ...
                              null != e.data &&
                                ...
                                (r.data =
                                  t.bytes === String
                                    ? c.base64.encode(e.data, 0, e.data.length)
                                    : t.bytes === Array
                      ...
                      (n.contract_call_bundle = (function () {
                        ...
                        return (
                          (t.prototype.contract_id = c.newBuffer([])),
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n =
                                  new l.koinos.protocol.contract_call_bundle();
                              e.pos < r;
                          ...
                          (t.fromObject = function (e) {
                            if (
                              e instanceof
                              l.koinos.protocol.contract_call_bundle
                            )
                              return e;
                            var t =
                              new l.koinos.protocol.contract_call_bundle();
                            return (
                              null != e.contract_id &&
                                ("string" == typeof e.contract_id
                                  ? c.base64.decode(
                                      e.contract_id,
                                      (t.contract_id = c.newBuffer(
                                        c.base64.length(e.contract_id)
                                      )),
                                      0
                                    )
                                  : e.contract_id.length >= 0 &&
                          ...
                          (t.getTypeUrl = function (e) {
                            return (
                              void 0 === e && (e = "type.googleapis.com"),
                              e + "/koinos.protocol.contract_call_bundle"
                            );
                          }),
                          t
                        );
                      ...
                      (n.system_call_target = (function () {
                        ...
                        return (
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n = new l.koinos.protocol.system_call_target();
                              e.pos < r;
                              ...
                              switch (o >>> 3) {
                                ...
                                case 2:
                                  n.system_call_bundle =
                                    l.koinos.protocol.contract_call_bundle.decode(
                                      e,
                                      e.uint32()
                                    );
                                  break;
                          ...
                          (t.verify = function (e) {
                            ...
                            if (
                              ...
                              ((t.target = 1), !c.isInteger(e.thunk_id))
                            )
                            ...
                            if (
                              ...
                              t.target = 1;
                              var r =
                                l.koinos.protocol.contract_call_bundle.verify(
                                  e.system_call_bundle
                                );
                          ...
                          (t.fromObject = function (e) {
                            if (
                              e instanceof l.koinos.protocol.system_call_target
                            )
                              return e;
                            var t = new l.koinos.protocol.system_call_target();
                            if (
                              (null != e.thunk_id &&
                              ...
                              t.system_call_bundle =
                                l.koinos.protocol.contract_call_bundle.fromObject(
                                  e.system_call_bundle
                                );
                            }
                            return t;
                            ...
                            return (
                              ...
                              null != e.system_call_bundle &&
                                ...
                                ((r.system_call_bundle =
                                  l.koinos.protocol.contract_call_bundle.toObject(
                                    e.system_call_bundle,
                                    t
                                  )),
                          ...
                          (t.getTypeUrl = function (e) {
                            return (
                              void 0 === e && (e = "type.googleapis.com"),
                              e + "/koinos.protocol.system_call_target"
                            );
                          }),
                          t
                        );
                      ...
                      (n.upload_contract_operation = (function () {
                        ...
                        return (
                          (t.prototype.contract_id = c.newBuffer([])),
                          (t.prototype.bytecode = c.newBuffer([])),
                          (t.prototype.abi = ""),
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n =
                                  new l.koinos.protocol.upload_contract_operation();
                              e.pos < r;
                          ...
                          (t.fromObject = function (e) {
                            if (
                              e instanceof
                              l.koinos.protocol.upload_contract_operation
                            )
                              return e;
                            var t =
                              new l.koinos.protocol.upload_contract_operation();
                            return (
                              ...
                              null != e.bytecode &&
                                ("string" == typeof e.bytecode
                                  ? c.base64.decode(
                                      e.bytecode,
                                      (t.bytecode = c.newBuffer(
                                        c.base64.length(e.bytecode)
                                      )),
                                      0
                                    )
                                  : e.bytecode.length >= 0 &&
                            ...
                            return (
                              t.defaults &&
                                ...
                                t.bytes === String
                                  ...
                                  : ((r.bytecode = []),
                                    t.bytes !== Array &&
                                      (r.bytecode = c.newBuffer(r.bytecode))),
                                (r.abi = ""),
                          ...
                          (t.getTypeUrl = function (e) {
                            return (
                              void 0 === e && (e = "type.googleapis.com"),
                              e + "/koinos.protocol.upload_contract_operation"
                            );
                          }),
                          t
                        );
                        ...
                        return (
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n =
                                  new l.koinos.protocol.call_contract_operation();
                              e.pos < r;
                          ...
                          (t.fromObject = function (e) {
                            if (
                              e instanceof
                              l.koinos.protocol.call_contract_operation
                            )
                              return e;
                            var t =
                              new l.koinos.protocol.call_contract_operation();
                              ...
                              null != e.args &&
                                ("string" == typeof e.args
                                  ? c.base64.decode(
                                      e.args,
                                      (t.args = c.newBuffer(
                                        c.base64.length(e.args)
                                      )),
                                      0
                                    )
                                  : e.args.length >= 0 && (t.args = e.args)),
                              t
                            );
                          }),
                          (t.toObject = function (e, t) {
                            ...
                            return (
                              ...
                              null != e.args &&
                                ...
                                (r.args =
                                  t.bytes === String
                                    ? c.base64.encode(e.args, 0, e.args.length)
                                    : t.bytes === Array
                          ...
                          (t.getTypeUrl = function (e) {
                            return (
                              void 0 === e && (e = "type.googleapis.com"),
                              e + "/koinos.protocol.call_contract_operation"
                            );
                          }),
                          t
                        );
                        ...
                        return (
                          ...
                          (t.encode = function (e, t) {
                            return (
                              ...
                              null != e.target &&
                                ...
                                l.koinos.protocol.system_call_target
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n =
                                  new l.koinos.protocol.set_system_call_operation();
                              e.pos < r;
                              ...
                              switch (o >>> 3) {
                                ...
                                case 2:
                                  n.target =
                                    l.koinos.protocol.system_call_target.decode(
                                      e,
                                      e.uint32()
                                    );
                                  break;
                          ...
                          (t.verify = function (e) {
                            ...
                            if (
                              ...
                              var t =
                                l.koinos.protocol.system_call_target.verify(
                                  e.target
                                );
                          ...
                          (t.fromObject = function (e) {
                            if (
                              e instanceof
                              l.koinos.protocol.set_system_call_operation
                            )
                              return e;
                            var t =
                              new l.koinos.protocol.set_system_call_operation();
                            if (
                              ...
                              t.target =
                                l.koinos.protocol.system_call_target.fromObject(
                                  e.target
                                );
                            }
                            return t;
                          ...
                          (t.toObject = function (e, t) {
                            ...
                            return (
                              ...
                              null != e.target &&
                                e.hasOwnProperty("target") &&
                                (r.target =
                                  l.koinos.protocol.system_call_target.toObject(
                                    e.target,
                                    t
                                  )),
                              r
                          ...
                          (t.getTypeUrl = function (e) {
                            return (
                              void 0 === e && (e = "type.googleapis.com"),
                              e + "/koinos.protocol.set_system_call_operation"
                            );
                          }),
                          t
                        );
                        ...
                        return (
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n =
                                  new l.koinos.protocol.set_system_contract_operation();
                              e.pos < r;
                          ...
                          (t.fromObject = function (e) {
                            if (
                              e instanceof
                              l.koinos.protocol.set_system_contract_operation
                            )
                              return e;
                            var t =
                              new l.koinos.protocol.set_system_contract_operation();
                      ...
                      (n.operation = (function () {
                        ...
                        return (
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n = new l.koinos.protocol.operation();
                              e.pos < r;
                              ...
                              switch (o >>> 3) {
                                case 1:
                                  n.upload_contract =
                                    l.koinos.protocol.upload_contract_operation.decode(
                                      e,
                                      e.uint32()
                                    );
                                  break;
                                case 2:
                                  n.call_contract =
                                    l.koinos.protocol.call_contract_operation.decode(
                                      e,
                                      e.uint32()
                                    );
                                  break;
                                case 3:
                                  n.set_system_call =
                                    l.koinos.protocol.set_system_call_operation.decode(
                                      e,
                                      e.uint32()
                                    );
                                  break;
                                case 4:
                                  n.set_system_contract =
                                    l.koinos.protocol.set_system_contract_operation.decode(
                                      e,
                                      e.uint32()
                                    );
                                  break;
                          ...
                          (t.verify = function (e) {
                            ...
                            if (
                              ...
                              ((t.op = 1),
                              (r =
                                l.koinos.protocol.upload_contract_operation.verify(
                                  e.upload_contract
                                )))
                            )
                            ...
                            if (
                              ...
                              if (
                                ((t.op = 1),
                                (r =
                                  l.koinos.protocol.call_contract_operation.verify(
                                    e.call_contract
                                  )))
                              )
                            ...
                            if (
                              ...
                              if (
                                ((t.op = 1),
                                (r =
                                  l.koinos.protocol.set_system_call_operation.verify(
                                    e.set_system_call
                                  )))
                              )
                            ...
                            if (
                              ...
                              if (
                                ((t.op = 1),
                                (r =
                                  l.koinos.protocol.set_system_contract_operation.verify(
                                    e.set_system_contract
                                  )))
                              )
                          ...
                          (t.fromObject = function (e) {
                            if (e instanceof l.koinos.protocol.operation)
                              return e;
                            var t = new l.koinos.protocol.operation();
                            if (null != e.upload_contract) {
                              ...
                              t.upload_contract =
                                l.koinos.protocol.upload_contract_operation.fromObject(
                                  e.upload_contract
                                );
                            }
                            if (null != e.call_contract) {
                              ...
                              t.call_contract =
                                l.koinos.protocol.call_contract_operation.fromObject(
                                  e.call_contract
                                );
                            }
                            if (null != e.set_system_call) {
                              ...
                              t.set_system_call =
                                l.koinos.protocol.set_system_call_operation.fromObject(
                                  e.set_system_call
                                );
                            }
                            if (null != e.set_system_contract) {
                              ...
                              t.set_system_contract =
                                l.koinos.protocol.set_system_contract_operation.fromObject(
                                  e.set_system_contract
                                );
                            }
                            return t;
                          ...
                          (t.toObject = function (e, t) {
                            ...
                            return (
                              null != e.upload_contract &&
                                e.hasOwnProperty("upload_contract") &&
                                ((r.upload_contract =
                                  l.koinos.protocol.upload_contract_operation.toObject(
                                    e.upload_contract,
                                    t
                                  )),
                              ...
                              null != e.call_contract &&
                                e.hasOwnProperty("call_contract") &&
                                ((r.call_contract =
                                  l.koinos.protocol.call_contract_operation.toObject(
                                    e.call_contract,
                                    t
                                  )),
                              ...
                              null != e.set_system_call &&
                                e.hasOwnProperty("set_system_call") &&
                                ((r.set_system_call =
                                  l.koinos.protocol.set_system_call_operation.toObject(
                                    e.set_system_call,
                                    t
                                  )),
                              ...
                              null != e.set_system_contract &&
                                ...
                                ((r.set_system_contract =
                                  l.koinos.protocol.set_system_contract_operation.toObject(
                                    e.set_system_contract,
                                    t
                                  )),
                      ...
                      (n.transaction_header = (function () {
                        ...
                        return (
                          (t.prototype.chain_id = c.newBuffer([])),
                          (t.prototype.rc_limit = c.Long
                            ? c.Long.fromBits(0, 0, !0)
                            : 0),
                          (t.prototype.nonce = c.newBuffer([])),
                          (t.prototype.operation_merkle_root = c.newBuffer([])),
                          (t.prototype.payer = c.newBuffer([])),
                          (t.prototype.payee = c.newBuffer([])),
                          (t.create = function (e) {
                            return new t(e);
                          }),
                          (t.encode = function (e, t) {
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n = new l.koinos.protocol.transaction_header();
                              e.pos < r;
                            ...
                            return "object" != typeof e || null === e
                              ...
                              : null != e.rc_limit &&
                                ...
                                !(
                                  ...
                                  (e.rc_limit &&
                                    c.isInteger(e.rc_limit.low) &&
                                    c.isInteger(e.rc_limit.high))
                                )
                              ...
                              : null != e.operation_merkle_root &&
                                ...
                                !(
                                  ...
                                  c.isString(e.operation_merkle_root)
                                )
                          ...
                          (t.fromObject = function (e) {
                            if (
                              e instanceof l.koinos.protocol.transaction_header
                            )
                              return e;
                            var t = new l.koinos.protocol.transaction_header();
                            return (
                              null != e.chain_id &&
                                ("string" == typeof e.chain_id
                                  ? c.base64.decode(
                                      e.chain_id,
                                      (t.chain_id = c.newBuffer(
                                        c.base64.length(e.chain_id)
                                      )),
                                      0
                                    )
                                  : e.chain_id.length >= 0 &&
                              ...
                              null != e.nonce &&
                                ("string" == typeof e.nonce
                                  ? c.base64.decode(
                                      e.nonce,
                                      (t.nonce = c.newBuffer(
                                        c.base64.length(e.nonce)
                                      )),
                                      0
                                    )
                                  : e.nonce.length >= 0 && (t.nonce = e.nonce)),
                              null != e.operation_merkle_root &&
                                ("string" == typeof e.operation_merkle_root
                                  ? c.base64.decode(
                                      e.operation_merkle_root,
                                      (t.operation_merkle_root = c.newBuffer(
                                        c.base64.length(e.operation_merkle_root)
                                      )),
                                      0
                                    )
                                  : e.operation_merkle_root.length >= 0 &&
                              ...
                              null != e.payer &&
                                ("string" == typeof e.payer
                                  ? c.base64.decode(
                                      e.payer,
                                      (t.payer = c.newBuffer(
                                        c.base64.length(e.payer)
                                      )),
                                      0
                                    )
                                  : e.payer.length >= 0 && (t.payer = e.payer)),
                              null != e.payee &&
                                ("string" == typeof e.payee
                                  ? c.base64.decode(
                                      e.payee,
                                      (t.payee = c.newBuffer(
                                        c.base64.length(e.payee)
                                      )),
                                      0
                                    )
                                  : e.payee.length >= 0 && (t.payee = e.payee)),
                              t
                            );
                          }),
                          (t.toObject = function (e, t) {
                            ...
                            if (t.defaults) {
                              if (
                                (t.bytes === String
                                  ...
                                  : ((r.chain_id = []),
                                    t.bytes !== Array &&
                                      (r.chain_id = c.newBuffer(r.chain_id))),
                                c.Long)
                              ) {
                                var n = new c.Long(0, 0, !0);
                                r.rc_limit =
                                  t.longs === String
                                    ? n.toString()
                                    : t.longs === Number
                              ...
                              t.bytes === String
                                ...
                                : ((r.nonce = []),
                                  t.bytes !== Array &&
                                    (r.nonce = c.newBuffer(r.nonce))),
                                t.bytes === String
                                  ? (r.operation_merkle_root = "")
                                  : ((r.operation_merkle_root = []),
                                    t.bytes !== Array &&
                                      (r.operation_merkle_root = c.newBuffer(
                                        r.operation_merkle_root
                                      ))),
                                t.bytes === String
                                  ? (r.payer = "")
                                  : ((r.payer = []),
                                    t.bytes !== Array &&
                                      (r.payer = c.newBuffer(r.payer))),
                                t.bytes === String
                                  ? (r.payee = "")
                                  : ((r.payee = []),
                                    t.bytes !== Array &&
                                      (r.payee = c.newBuffer(r.payee)));
                            }
                            return (
                              null != e.chain_id &&
                                e.hasOwnProperty("chain_id") &&
                              ...
                              null != e.rc_limit &&
                                ...
                                ("number" == typeof e.rc_limit
                                  ...
                                  : (r.rc_limit =
                                      t.longs === String
                                        ? c.Long.prototype.toString.call(
                                            e.rc_limit
                                          )
                                        : t.longs === Number
                                        ? new c.LongBits(
                          ...
                          (t.getTypeUrl = function (e) {
                            return (
                              void 0 === e && (e = "type.googleapis.com"),
                              e + "/koinos.protocol.transaction_header"
                            );
                          }),
                          t
                        );
                      ...
                      (n.transaction = (function () {
                        ...
                        return (
                          (t.prototype.id = c.newBuffer([])),
                          (t.prototype.header = null),
                          (t.prototype.operations = c.emptyArray),
                          (t.prototype.signatures = c.emptyArray),
                          (t.create = function (e) {
                            return new t(e);
                          }),
                          (t.encode = function (e, t) {
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n = new l.koinos.protocol.transaction();
                              e.pos < r;
                              ...
                              switch (o >>> 3) {
                                ...
                                case 2:
                                  n.header =
                                    l.koinos.protocol.transaction_header.decode(
                                      e,
                                      e.uint32()
                                    );
                                  break;
                                case 3:
                                  (n.operations && n.operations.length) ||
                                    (n.operations = []),
                                    n.operations.push(
                                      l.koinos.protocol.operation.decode(
                                        e,
                                        e.uint32()
                                      )
                                    );
                          ...
                          (t.verify = function (e) {
                            ...
                            if (
                              ...
                              (r = l.koinos.protocol.transaction_header.verify(
                                e.header
                              ))
                            )
                              return "header." + r;
                            if (
                              ...
                              for (var t = 0; t < e.operations.length; ++t) {
                                var r;
                                if (
                                  (r = l.koinos.protocol.operation.verify(
                                    e.operations[t]
                                  ))
                                )
                                  return "operations." + r;
                          ...
                          (t.fromObject = function (e) {
                            if (e instanceof l.koinos.protocol.transaction)
                              return e;
                            var t = new l.koinos.protocol.transaction();
                            if (
                              (null != e.id &&
                                ("string" == typeof e.id
                                  ? c.base64.decode(
                                      e.id,
                                      (t.id = c.newBuffer(
                                        c.base64.length(e.id)
                                      )),
                                      0
                                    )
                                  : e.id.length >= 0 && (t.id = e.id)),
                              null != e.header)
                            ) {
                              ...
                              t.header =
                                l.koinos.protocol.transaction_header.fromObject(
                                  e.header
                                );
                            }
                            if (e.operations) {
                              ...
                              for (var r = 0; r < e.operations.length; ++r) {
                                ...
                                t.operations[r] =
                                  l.koinos.protocol.operation.fromObject(
                                    e.operations[r]
                                  );
                              }
                            }
                            if (e.signatures) {
                              ...
                              for (
                                ...
                                "string" == typeof e.signatures[r]
                                  ? c.base64.decode(
                                      e.signatures[r],
                                      (t.signatures[r] = c.newBuffer(
                                        c.base64.length(e.signatures[r])
                                      )),
                                      0
                                    )
                                  : e.signatures[r].length >= 0 &&
                            ...
                            if (
                              ...
                              t.defaults &&
                                (t.bytes === String
                                  ...
                                  : ((r.id = []),
                                    t.bytes !== Array &&
                                      (r.id = c.newBuffer(r.id))),
                                (r.header = null)),
                              null != e.id &&
                                e.hasOwnProperty("id") &&
                                (r.id =
                                  t.bytes === String
                                    ? c.base64.encode(e.id, 0, e.id.length)
                                    : t.bytes === Array
                              ...
                              null != e.header &&
                                e.hasOwnProperty("header") &&
                                (r.header =
                                  l.koinos.protocol.transaction_header.toObject(
                                    e.header,
                                    t
                                  )),
                              ...
                              for (var n = 0; n < e.operations.length; ++n)
                                r.operations[n] =
                                  l.koinos.protocol.operation.toObject(
                                    e.operations[n],
                                    t
                                  );
                            }
                      ...
                      (n.transaction_receipt = (function () {
                        ...
                        return (
                          (t.prototype.id = c.newBuffer([])),
                          (t.prototype.payer = c.newBuffer([])),
                          (t.prototype.max_payer_rc = c.Long
                            ? c.Long.fromBits(0, 0, !0)
                            : 0),
                          (t.prototype.rc_limit = c.Long
                            ? c.Long.fromBits(0, 0, !0)
                            : 0),
                          (t.prototype.rc_used = c.Long
                            ? c.Long.fromBits(0, 0, !0)
                            : 0),
                          (t.prototype.disk_storage_used = c.Long
                            ? c.Long.fromBits(0, 0, !0)
                            : 0),
                          (t.prototype.network_bandwidth_used = c.Long
                            ? c.Long.fromBits(0, 0, !0)
                            : 0),
                          (t.prototype.compute_bandwidth_used = c.Long
                            ? c.Long.fromBits(0, 0, !0)
                            : 0),
                          (t.prototype.reverted = !1),
                          (t.prototype.events = c.emptyArray),
                          (t.prototype.logs = c.emptyArray),
                          (t.create = function (e) {
                            return new t(e);
                          }),
                          (t.encode = function (e, t) {
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n = new l.koinos.protocol.transaction_receipt();
                              e.pos < r;
                              ...
                              switch (o >>> 3) {
                                ...
                                case 10:
                                  (n.events && n.events.length) ||
                                    (n.events = []),
                                    n.events.push(
                                      l.koinos.protocol.event_data.decode(
                                        e,
                                        e.uint32()
                                      )
                                    );
                          ...
                          (t.verify = function (e) {
                            ...
                            if (
                              ...
                              !(
                                c.isInteger(e.max_payer_rc) ||
                                (e.max_payer_rc &&
                                  c.isInteger(e.max_payer_rc.low) &&
                                  c.isInteger(e.max_payer_rc.high))
                              )
                            )
                            ...
                            if (
                              ...
                              !(
                                c.isInteger(e.rc_used) ||
                                (e.rc_used &&
                                  c.isInteger(e.rc_used.low) &&
                                  c.isInteger(e.rc_used.high))
                              )
                            )
                            ...
                            if (
                              ...
                              !(
                                ...
                                (e.disk_storage_used &&
                                  c.isInteger(e.disk_storage_used.low) &&
                                  c.isInteger(e.disk_storage_used.high))
                              )
                            )
                            ...
                            if (
                              ...
                              !(
                                c.isInteger(e.network_bandwidth_used) ||
                                (e.network_bandwidth_used &&
                                  c.isInteger(e.network_bandwidth_used.low) &&
                                  c.isInteger(e.network_bandwidth_used.high))
                              )
                            )
                            ...
                            if (
                              ...
                              !(
                                ...
                                (e.compute_bandwidth_used &&
                                  c.isInteger(e.compute_bandwidth_used.low) &&
                                  c.isInteger(e.compute_bandwidth_used.high))
                              )
                            )
                            ...
                            if (
                              ...
                              for (var t = 0; t < e.events.length; ++t) {
                                var r = l.koinos.protocol.event_data.verify(
                                  e.events[t]
                                );
                          ...
                          (t.fromObject = function (e) {
                            if (
                              e instanceof l.koinos.protocol.transaction_receipt
                            )
                              return e;
                            var t = new l.koinos.protocol.transaction_receipt();
                            if (
                              (null != e.id &&
                                ("string" == typeof e.id
                                  ? c.base64.decode(
                              ...
                              null != e.max_payer_rc &&
                                (c.Long
                                  ? ((t.max_payer_rc = c.Long.fromValue(
                                      e.max_payer_rc
                                    )).unsigned = !0)
                              ...
                              null != e.rc_used &&
                                (c.Long
                                  ...
                                  : "object" == typeof e.rc_used &&
                                    (t.rc_used = new c.LongBits(
                                      e.rc_used.low >>> 0,
                                      e.rc_used.high >>> 0
                                    ).toNumber(!0))),
                              null != e.disk_storage_used &&
                                (c.Long
                                  ? ((t.disk_storage_used = c.Long.fromValue(
                                      e.disk_storage_used
                                    )).unsigned = !0)
                                  ...
                                  : "object" == typeof e.disk_storage_used &&
                                    (t.disk_storage_used = new c.LongBits(
                              ...
                              null != e.network_bandwidth_used &&
                                (c.Long
                                  ...
                                  : "object" ==
                                    ...
                                    (t.network_bandwidth_used = new c.LongBits(
                              ...
                              null != e.compute_bandwidth_used &&
                                (c.Long
                                  ...
                                  : "object" ==
                                    ...
                                    (t.compute_bandwidth_used = new c.LongBits(
                              ...
                              for (var r = 0; r < e.events.length; ++r) {
                                ...
                                t.events[r] =
                                  l.koinos.protocol.event_data.fromObject(
                                    e.events[r]
                                  );
                              }
                            }
                          ...
                          (t.toObject = function (e, t) {
                            ...
                            if (
                              ...
                              for (var o = 0; o < e.events.length; ++o)
                                r.events[o] =
                                  l.koinos.protocol.event_data.toObject(
                                    e.events[o],
                                    t
                                  );
                            }
                          ...
                          (t.getTypeUrl = function (e) {
                            return (
                              void 0 === e && (e = "type.googleapis.com"),
                              e + "/koinos.protocol.transaction_receipt"
                            );
                          }),
                          t
                        );
                      ...
                      (n.block_header = (function () {
                        ...
                        return (
                          (t.prototype.previous = c.newBuffer([])),
                          (t.prototype.height = c.Long
                            ? c.Long.fromBits(0, 0, !0)
                            : 0),
                          (t.prototype.timestamp = c.Long
                            ? c.Long.fromBits(0, 0, !0)
                            : 0),
                          (t.prototype.previous_state_merkle_root = c.newBuffer(
                            []
                          )),
                          (t.prototype.transaction_merkle_root = c.newBuffer(
                            []
                          )),
                          (t.prototype.signer = c.newBuffer([])),
                          (t.prototype.approved_proposals = c.emptyArray),
                          (t.create = function (e) {
                            return new t(e);
                          }),
                          (t.encode = function (e, t) {
                            if (
                              ...
                              null != e.approved_proposals &&
                                e.approved_proposals.length)
                            )
                              for (
                                var r = 0;
                                r < e.approved_proposals.length;
                                ++r
                              )
                                t.uint32(58).bytes(e.approved_proposals[r]);
                            return t;
                          }),
                          (t.encodeDelimited = function (e, t) {
                            return this.encode(e, t).ldelim();
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n = new l.koinos.protocol.block_header();
                              e.pos < r;
                              ...
                              switch (o >>> 3) {
                                ...
                                case 6:
                                  ...
                                  break;
                                case 7:
                                  (n.approved_proposals &&
                                    n.approved_proposals.length) ||
                                    (n.approved_proposals = []),
                                    n.approved_proposals.push(e.bytes());
                                  break;
                                default:
                                  e.skipType(7 & o);
                              }
                          ...
                          (t.verify = function (e) {
                            ...
                            if (
                              ...
                              !(
                                c.isInteger(e.height) ||
                                (e.height &&
                                  c.isInteger(e.height.low) &&
                                  c.isInteger(e.height.high))
                              )
                            )
                            ...
                            if (
                              null != e.previous_state_merkle_root &&
                              e.hasOwnProperty("previous_state_merkle_root") &&
                              !(
                                (e.previous_state_merkle_root &&
                                  "number" ==
                                    typeof e.previous_state_merkle_root
                                      .length) ||
                                c.isString(e.previous_state_merkle_root)
                              )
                            )
                            ...
                            if (
                              ...
                              !(
                                (e.transaction_merkle_root &&
                                  "number" ==
                                    typeof e.transaction_merkle_root.length) ||
                                c.isString(e.transaction_merkle_root)
                              )
                            )
                            ...
                            if (
                              null != e.approved_proposals &&
                              e.hasOwnProperty("approved_proposals")
                            ) {
                              if (!Array.isArray(e.approved_proposals))
                                return "approved_proposals: array expected";
                              for (
                                var t = 0;
                                t < e.approved_proposals.length;
                                ++t
                              )
                                if (
                                  !(
                                    (e.approved_proposals[t] &&
                                      "number" ==
                                        typeof e.approved_proposals[t]
                                          .length) ||
                                    c.isString(e.approved_proposals[t])
                                  )
                                )
                          ...
                          (t.fromObject = function (e) {
                            if (e instanceof l.koinos.protocol.block_header)
                              return e;
                            var t = new l.koinos.protocol.block_header();
                            if (
                              (null != e.previous &&
                                ("string" == typeof e.previous
                                  ? c.base64.decode(
                                      e.previous,
                                      (t.previous = c.newBuffer(
                                        c.base64.length(e.previous)
                                      )),
                                      0
                                    )
                                  : e.previous.length >= 0 &&
                              ...
                              null != e.height &&
                                (c.Long
                                  ...
                                  : "object" == typeof e.height &&
                                    (t.height = new c.LongBits(
                                      e.height.low >>> 0,
                                      e.height.high >>> 0
                                    ).toNumber(!0))),
                              null != e.timestamp &&
                                (c.Long
                                  ? ((t.timestamp = c.Long.fromValue(
                                      e.timestamp
                                    )).unsigned = !0)
                              ...
                              null != e.previous_state_merkle_root &&
                                ("string" == typeof e.previous_state_merkle_root
                                  ...
                                  : e.previous_state_merkle_root.length >= 0 &&
                                    (t.previous_state_merkle_root =
                                      e.previous_state_merkle_root)),
                              null != e.transaction_merkle_root &&
                                ("string" == typeof e.transaction_merkle_root
                                  ? c.base64.decode(
                                      e.transaction_merkle_root,
                                      (t.transaction_merkle_root = c.newBuffer(
                                        c.base64.length(
                                          e.transaction_merkle_root
                                        )
                                      )),
                                  ...
                                  : e.transaction_merkle_root.length >= 0 &&
                              ...
                              null != e.signer &&
                                ("string" == typeof e.signer
                                  ? c.base64.decode(
                                      e.signer,
                                      (t.signer = c.newBuffer(
                                        c.base64.length(e.signer)
                                      )),
                                      0
                                    )
                                  : e.signer.length >= 0 &&
                                    (t.signer = e.signer)),
                              e.approved_proposals)
                            ) {
                              if (!Array.isArray(e.approved_proposals))
                                throw TypeError(
                                  ".koinos.protocol.block_header.approved_proposals: array expected"
                                );
                              t.approved_proposals = [];
                              for (
                                var r = 0;
                                r < e.approved_proposals.length;
                                ++r
                              )
                                "string" == typeof e.approved_proposals[r]
                                  ? c.base64.decode(
                                      e.approved_proposals[r],
                                      (t.approved_proposals[r] = c.newBuffer(
                                        c.base64.length(e.approved_proposals[r])
                                      )),
                                      0
                                    )
                                  : e.approved_proposals[r].length >= 0 &&
                                    (t.approved_proposals[r] =
                                      e.approved_proposals[r]);
                            }
                            return t;
                          }),
                          (t.toObject = function (e, t) {
                            ...
                            if (
                              ...
                              if (
                                (t.bytes === String
                                  ...
                                  : ((r.previous = []),
                                    t.bytes !== Array &&
                                      (r.previous = c.newBuffer(r.previous))),
                                c.Long)
                              ) {
                                var n = new c.Long(0, 0, !0);
                                r.height =
                              ...
                              c.Long
                                ...
                                t.bytes === String
                                  ...
                                  : ((r.transaction_merkle_root = []),
                                    t.bytes !== Array &&
                                      (r.transaction_merkle_root = c.newBuffer(
                                        r.transaction_merkle_root
                                      ))),
                                t.bytes === String
                                  ? (r.signer = "")
                            ...
                            if (
                              ...
                              for (
                                var o = 0;
                                o < e.approved_proposals.length;
                                ++o
                              )
                                r.approved_proposals[o] =
                                  t.bytes === String
                                    ? c.base64.encode(
                                        e.approved_proposals[o],
                                        0,
                                        e.approved_proposals[o].length
                                      )
                                    : t.bytes === Array
                                    ? Array.prototype.slice.call(
                                        e.approved_proposals[o]
                          ...
                          (t.getTypeUrl = function (e) {
                            return (
                              void 0 === e && (e = "type.googleapis.com"),
                              e + "/koinos.protocol.block_header"
                            );
                          }),
                          t
                        );
                      ...
                      (n.block = (function () {
                        ...
                        return (
                          (t.prototype.id = c.newBuffer([])),
                          (t.prototype.header = null),
                          (t.prototype.transactions = c.emptyArray),
                          (t.prototype.signature = c.newBuffer([])),
                          (t.create = function (e) {
                            return new t(e);
                          }),
                          (t.encode = function (e, t) {
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              ...
                              switch (o >>> 3) {
                                ...
                                case 2:
                                  n.header =
                                    l.koinos.protocol.block_header.decode(
                                      e,
                                      e.uint32()
                                    );
                                  break;
                                case 3:
                                  (n.transactions && n.transactions.length) ||
                                    (n.transactions = []),
                                    n.transactions.push(
                                      l.koinos.protocol.transaction.decode(
                                        e,
                                        e.uint32()
                                      )
                                    );
                          ...
                          (t.verify = function (e) {
                            ...
                            if (
                              null != e.header &&
                              e.hasOwnProperty("header") &&
                              (r = l.koinos.protocol.block_header.verify(
                                e.header
                              ))
                            )
                              return "header." + r;
                            if (
                              ...
                              for (var t = 0; t < e.transactions.length; ++t) {
                                var r;
                                if (
                                  (r = l.koinos.protocol.transaction.verify(
                                    e.transactions[t]
                                  ))
                                )
                            ...
                            return null != e.signature &&
                              ...
                              !(
                                ...
                                c.isString(e.signature)
                              )
                              ? "signature: buffer expected"
                              : null;
                          }),
                          (t.fromObject = function (e) {
                            if (e instanceof l.koinos.protocol.block) return e;
                            var t = new l.koinos.protocol.block();
                            if (
                              (null != e.id &&
                                ("string" == typeof e.id
                                  ? c.base64.decode(
                              ...
                              t.header =
                                l.koinos.protocol.block_header.fromObject(
                                  e.header
                                );
                            }
                            if (e.transactions) {
                              ...
                              for (var r = 0; r < e.transactions.length; ++r) {
                                ...
                                t.transactions[r] =
                                  l.koinos.protocol.transaction.fromObject(
                                    e.transactions[r]
                                  );
                              }
                            }
                            return (
                              null != e.signature &&
                                ("string" == typeof e.signature
                                  ? c.base64.decode(
                                      e.signature,
                                      (t.signature = c.newBuffer(
                                        c.base64.length(e.signature)
                                      )),
                                      0
                                    )
                          ...
                          (t.toObject = function (e, t) {
                            ...
                            if (
                              ...
                              null != e.header &&
                                e.hasOwnProperty("header") &&
                                (r.header =
                                  l.koinos.protocol.block_header.toObject(
                                    e.header,
                                    t
                                  )),
                              ...
                              for (var n = 0; n < e.transactions.length; ++n)
                                r.transactions[n] =
                                  l.koinos.protocol.transaction.toObject(
                                    e.transactions[n],
                                    t
                                  );
                            }
                      ...
                      (n.block_receipt = (function () {
                        ...
                        return (
                          ...
                          (t.prototype.compute_bandwidth_used = c.Long
                            ? c.Long.fromBits(0, 0, !0)
                            : 0),
                          (t.prototype.state_merkle_root = c.newBuffer([])),
                          (t.prototype.events = c.emptyArray),
                          (t.prototype.transaction_receipts = c.emptyArray),
                          (t.prototype.logs = c.emptyArray),
                          (t.create = function (e) {
                            return new t(e);
                          }),
                          (t.encode = function (e, t) {
                            ...
                            if (
                              ...
                              for (
                                ...
                                l.koinos.protocol.transaction_receipt
                                  .encode(
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n = new l.koinos.protocol.block_receipt();
                              e.pos < r;
                                ...
                                case 8:
                                  (n.transaction_receipts &&
                                    ...
                                    n.transaction_receipts.push(
                                      l.koinos.protocol.transaction_receipt.decode(
                                        e,
                                        e.uint32()
                                      )
                                    );
                          ...
                          (t.verify = function (e) {
                            ...
                            if (
                              ...
                              !(
                                ...
                                c.isString(e.state_merkle_root)
                              )
                            )
                            ...
                            if (
                              ...
                              for (var t = 0; t < e.events.length; ++t)
                                if (
                                  (r = l.koinos.protocol.event_data.verify(
                                    e.events[t]
                                  ))
                                )
                                  return "events." + r;
                            ...
                            if (
                              ...
                              for (
                                ...
                                if (
                                  (r =
                                    l.koinos.protocol.transaction_receipt.verify(
                          ...
                          (t.fromObject = function (e) {
                            if (e instanceof l.koinos.protocol.block_receipt)
                              return e;
                            var t = new l.koinos.protocol.block_receipt();
                            if (
                              (null != e.id &&
                                ("string" == typeof e.id
                                  ? c.base64.decode(
                              ...
                              null != e.state_merkle_root &&
                                ("string" == typeof e.state_merkle_root
                                  ? c.base64.decode(
                                      e.state_merkle_root,
                                      (t.state_merkle_root = c.newBuffer(
                                        c.base64.length(e.state_merkle_root)
                                      )),
                                      0
                                    )
                                  : e.state_merkle_root.length >= 0 &&
                                    (t.state_merkle_root =
                                      e.state_merkle_root)),
                              e.events)
                            ) {
                            ...
                            if (e.transaction_receipts) {
                              ...
                              for (
                                ...
                                t.transaction_receipts[r] =
                                  l.koinos.protocol.transaction_receipt.fromObject(
                                    e.transaction_receipts[r]
                                  );
                              }
                            }
                            ...
                            if (
                              ...
                              c.Long
                                ...
                                t.bytes === String
                                  ...
                                  : ((r.state_merkle_root = []),
                                    t.bytes !== Array &&
                                      (r.state_merkle_root = c.newBuffer(
                                        r.state_merkle_root
                                      )));
                            }
                            if (
                            ...
                            if (
                              ...
                              for (
                                ...
                                r.transaction_receipts[o] =
                                  l.koinos.protocol.transaction_receipt.toObject(
                          ...
                          (t.getTypeUrl = function (e) {
                            return (
                              void 0 === e && (e = "type.googleapis.com"),
                              e + "/koinos.protocol.block_receipt"
                            );
                          }),
                          t
                        );
                    ...
                    (i.chain =
                      (((o = {}).value_type = (function () {
                        ...
                        return (
                          ...
                          (t.encode = function (e, t) {
                            return (
                              ...
                              null != e.fixed64_value &&
                                ...
                                t.uint32(73).fixed64(e.fixed64_value),
                              ...
                              null != e.sfixed64_value &&
                                ...
                                t.uint32(89).sfixed64(e.sfixed64_value),
                              null != e.bool_value &&
                                Object.hasOwnProperty.call(e, "bool_value") &&
                                t.uint32(96).bool(e.bool_value),
                              null != e.string_value &&
                                Object.hasOwnProperty.call(e, "string_value") &&
                                t.uint32(106).string(e.string_value),
                              null != e.bytes_value &&
                                Object.hasOwnProperty.call(e, "bytes_value") &&
                                t.uint32(114).bytes(e.bytes_value),
                              t
                            );
                          }),
                          (t.encodeDelimited = function (e, t) {
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n = new l.koinos.chain.value_type();
                              e.pos < r;
                              ...
                              switch (o >>> 3) {
                                case 1:
                                  n.message_value =
                                    l.google.protobuf.Any.decode(e, e.uint32());
                                  break;
                                case 2:
                          ...
                          (t.verify = function (e) {
                            ...
                            if (
                              ...
                              t.kind = 1;
                              var r = l.google.protobuf.Any.verify(
                                e.message_value
                              );
                            ...
                            if (
                              ...
                              if (((t.kind = 1), !c.isInteger(e.int32_value)))
                            ...
                            if (
                              ...
                              if (
                                ((t.kind = 1),
                                !(
                                  c.isInteger(e.int64_value) ||
                                  (e.int64_value &&
                                    c.isInteger(e.int64_value.low) &&
                                    c.isInteger(e.int64_value.high))
                                ))
                              )
                            ...
                            if (
                              ...
                              if (1 === t.kind) return "kind: multiple values";
                              if (((t.kind = 1), !c.isInteger(e.uint32_value)))
                            ...
                            if (
                              ...
                              if (
                                ((t.kind = 1),
                                !(
                                  c.isInteger(e.uint64_value) ||
                                  (e.uint64_value &&
                                    c.isInteger(e.uint64_value.low) &&
                                    c.isInteger(e.uint64_value.high))
                                ))
                              )
                            ...
                            if (
                              ...
                              if (1 === t.kind) return "kind: multiple values";
                              if (((t.kind = 1), !c.isInteger(e.sint32_value)))
                            ...
                            if (
                              ...
                              if (
                                ((t.kind = 1),
                                !(
                                  c.isInteger(e.sint64_value) ||
                                  (e.sint64_value &&
                                    c.isInteger(e.sint64_value.low) &&
                                    c.isInteger(e.sint64_value.high))
                                ))
                              )
                            ...
                            if (
                              ...
                              if (
                                ((t.kind = 1),
                                !(
                                  c.isInteger(e.fixed64_value) ||
                                  (e.fixed64_value &&
                                    c.isInteger(e.fixed64_value.low) &&
                                    c.isInteger(e.fixed64_value.high))
                                ))
                              )
                            ...
                            if (
                              ...
                              if (1 === t.kind) return "kind: multiple values";
                              if (
                                ((t.kind = 1), !c.isInteger(e.sfixed32_value))
                              )
                            ...
                            if (
                              ...
                              if (
                                ((t.kind = 1),
                                !(
                                  c.isInteger(e.sfixed64_value) ||
                                  (e.sfixed64_value &&
                                    c.isInteger(e.sfixed64_value.low) &&
                                    c.isInteger(e.sfixed64_value.high))
                                ))
                              )
                            ...
                            if (
                              ...
                              if (1 === t.kind) return "kind: multiple values";
                              if (((t.kind = 1), !c.isString(e.string_value)))
                          ...
                          (t.fromObject = function (e) {
                            if (e instanceof l.koinos.chain.value_type)
                              return e;
                            var t = new l.koinos.chain.value_type();
                            if (null != e.message_value) {
                              ...
                              t.message_value =
                                l.google.protobuf.Any.fromObject(
                                  e.message_value
                                );
                            }
                            return (
                              ...
                              null != e.int64_value &&
                                (c.Long
                                  ? ((t.int64_value = c.Long.fromValue(
                                      e.int64_value
                                    )).unsigned = !1)
                              ...
                              null != e.uint64_value &&
                                (c.Long
                                  ? ((t.uint64_value = c.Long.fromValue(
                                      e.uint64_value
                                    )).unsigned = !0)
                              ...
                              null != e.sint64_value &&
                                (c.Long
                                  ? ((t.sint64_value = c.Long.fromValue(
                                      e.sint64_value
                                    )).unsigned = !1)
                              ...
                              null != e.fixed64_value &&
                                (c.Long
                                  ? ((t.fixed64_value = c.Long.fromValue(
                                      e.fixed64_value
                                    )).unsigned = !1)
                                  ...
                                  : "object" == typeof e.fixed64_value &&
                                    (t.fixed64_value = new c.LongBits(
                              ...
                              null != e.sfixed64_value &&
                                (c.Long
                                  ? ((t.sfixed64_value = c.Long.fromValue(
                                      e.sfixed64_value
                                    )).unsigned = !1)
                                  ...
                                  : "object" == typeof e.sfixed64_value &&
                                    (t.sfixed64_value = new c.LongBits(
                              ...
                              null != e.bytes_value &&
                                ("string" == typeof e.bytes_value
                                  ? c.base64.decode(
                                      e.bytes_value,
                                      (t.bytes_value = c.newBuffer(
                                        c.base64.length(e.bytes_value)
                                      )),
                                      0
                                    )
                                  : e.bytes_value.length >= 0 &&
                          ...
                          (t.toObject = function (e, t) {
                            ...
                            return (
                              null != e.message_value &&
                                e.hasOwnProperty("message_value") &&
                                ((r.message_value =
                                  l.google.protobuf.Any.toObject(
                                    e.message_value,
                                    t
                                  )),
                      ...
                      (o.enum_type = (function () {
                        ...
                        return (
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n = new l.koinos.chain.enum_type();
                              e.pos < r;
                          ...
                          (t.verify = function (e) {
                            return "object" != typeof e || null === e
                              ...
                              : null != e.number &&
                                ...
                                !c.isInteger(e.number)
                              ? "number: integer expected"
                              : null;
                          }),
                          (t.fromObject = function (e) {
                            if (e instanceof l.koinos.chain.enum_type) return e;
                            var t = new l.koinos.chain.enum_type();
                            return (
                              null != e.name && (t.name = String(e.name)),
                      ...
                      (o.list_type = (function () {
                        ...
                        return (
                          (t.prototype.values = c.emptyArray),
                          (t.create = function (e) {
                            return new t(e);
                          }),
                          (t.encode = function (e, t) {
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n = new l.koinos.chain.list_type();
                              e.pos < r;
                              ...
                              switch (o >>> 3) {
                                case 1:
                                  (n.values && n.values.length) ||
                                    (n.values = []),
                                    n.values.push(
                                      l.koinos.chain.value_type.decode(
                                        e,
                                        e.uint32()
                                      )
                                    );
                          ...
                          (t.verify = function (e) {
                            ...
                            if (
                              ...
                              for (var t = 0; t < e.values.length; ++t) {
                                var r = l.koinos.chain.value_type.verify(
                                  e.values[t]
                                );
                          ...
                          (t.fromObject = function (e) {
                            if (e instanceof l.koinos.chain.list_type) return e;
                            var t = new l.koinos.chain.list_type();
                            if (e.values) {
                              if (!Array.isArray(e.values))
                                throw TypeError(
                              ...
                              for (var r = 0; r < e.values.length; ++r) {
                                ...
                                t.values[r] =
                                  l.koinos.chain.value_type.fromObject(
                                    e.values[r]
                                  );
                              }
                            }
                          ...
                          (t.toObject = function (e, t) {
                            ...
                            if (
                              ...
                              for (var n = 0; n < e.values.length; ++n)
                                r.values[n] =
                                  l.koinos.chain.value_type.toObject(
                                    e.values[n],
                                    t
                                  );
                            }
                    ...
                    (((r = {}).protobuf =
                      (((t = {}).Any = (function () {
                        ...
                        return (
                          ...
                          (t.fromObject = function (e) {
                            if (e instanceof l.google.protobuf.Any) return e;
                            var t = new l.google.protobuf.Any();
                            return (
                              null != e.type_url &&
